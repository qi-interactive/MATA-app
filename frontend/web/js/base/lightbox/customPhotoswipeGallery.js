/*-------
This script expects to have a specific set of html markups. The parent wrapper of the images must have class .parent-wrapper, 
and the images link must have class .gallery__img--main. 
...
(function() {
	...
	var initPhotoSwipeFromDOM = function(gallerySelector) {
		...
		var parseThumbnailElements = function(el) {
			var thumbElements = el.querySelectorAll('.gallery__img--main'),
			...
			var onThumbnailsClick = function(e) {
				...
				var el1 = document.getElementById('parent-wrapper');
				var childNodes = el1.querySelectorAll('.gallery__img--main'),
		...
		initPhotoSwipeFromDOM('.parent-wrapper');
